...
class pbReqStart : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PointCloudProto.pbReqStart) */ {
 public:
  pbReqStart();
  virtual ~pbReqStart();
  ...
  // @@protoc_insertion_point(class_scope:PointCloudProto.pbReqStart)
 private:
